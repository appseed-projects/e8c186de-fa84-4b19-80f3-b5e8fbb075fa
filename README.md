...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-03-14 17:48`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/e8c186de-fa84-4b19-80f3-b5e8fbb075fa.git
$ cd e8c186de-fa84-4b19-80f3-b5e8fbb075fa
```
